...
insert sys_module(ModuleID,M_ApplicationID,M_ParentID,M_PageCode,M_CName,M_Directory,M_OrderLevel,M_IsSystem,M_Close) values(	1	,	1	,	0	,	'S00'	,	N'系统应用'	,	NULL	,	'0000'	,	1	,	0	)
...
insert sys_module(ModuleID,M_ApplicationID,M_ParentID,M_PageCode,M_CName,M_Directory,M_OrderLevel,M_IsSystem,M_Close) values(	7	,	1	,	1	,	'S00M04'	,	N'应用字段设定'	,	N'Module/FrameWork/SystemApp/FieldManager/default.aspx'	,	'0006'	,	1	,	0	)
...
insert sys_module(ModuleID,M_ApplicationID,M_ParentID,M_PageCode,M_CName,M_Directory,M_OrderLevel,M_IsSystem,M_Close) values(	29	,	1	,	27	,	'S01M01'	,	N'系统出错日志'	,	N'Module/FrameWork/SystemMaintenance/SystemErrorLog/default.aspx'	,	'0102'	,	1	,	0	)
