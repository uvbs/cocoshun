<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="true"
    Codebehind="Default.aspx.cs" Inherits="FrameWork.web.Manager.Module.App.News.Default"
    %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
        ButtonList-Capacity="4" HeadOPTxt="新闻管理列表" HeadTitleTxt="新闻发布管理" HeadHelpTxt="点击标题进入新闻管理">
        <FrameWorkWebControls:HeadMenuButtonItem ButtonPopedom="New" ButtonUrlType="Href"
            ButtonVisible="True" ButtonUrl="NewsManager.aspx?CMD=New" ButtonName="新闻" />
            ...
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated">
                <Columns>
                    ...
                    <asp:HyperLinkField SortExpression="U_LoginName" HeaderText="用户名" DataTextField="U_LoginName" DataNavigateUrlFields="UserID"
                        DataNavigateUrlFormatString="NewsManager.aspx?UserID={0}&CMD=List" />
