...
BOOL CSaveLyricDlg::OnInitDialog() 
{
	...
	SetControlInfo(IDC_STATIC_TI,ANCHORE_BOTTOM | ANCHORE_LEFT);
	SetControlInfo(IDC_STATIC_AR,ANCHORE_BOTTOM | ANCHORE_LEFT);
	SetControlInfo(IDC_STATIC_AL,ANCHORE_BOTTOM | ANCHORE_LEFT);
	SetControlInfo(IDC_STATIC_BY,ANCHORE_BOTTOM | ANCHORE_LEFT);

	SetControlInfo(IDC_EDIT_TI,ANCHORE_BOTTOM | ANCHORE_LEFT);
	SetControlInfo(IDC_EDIT_AR,ANCHORE_BOTTOM | ANCHORE_LEFT);
	SetControlInfo(IDC_EDIT_AL,ANCHORE_BOTTOM | ANCHORE_LEFT);
	SetControlInfo(IDC_EDIT_BY,ANCHORE_BOTTOM | ANCHORE_LEFT);

	SetControlInfo(IDC_BTN_SAVELYRIC,ANCHORE_BOTTOM | ANCHORE_LEFT);
