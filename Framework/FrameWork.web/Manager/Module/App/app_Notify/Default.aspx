<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="FrameWork.web.Manager.Module.App.Web.Module.FrameWork.web.Manager.Module.App.app_Notify.Default"
    Title="无标题页" %>
        ...
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="通知部门" SortExpression="Notifier" DataField="Notifier" />
                    <asp:BoundField HeaderText="通知时间" SortExpression="AddTime" DataField="AddTime" />
                    <asp:BoundField HeaderText="通知内容" SortExpression="Content" DataField="Content" />
                </Columns>
            </asp:GridView>
