            ...
            <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText = "">
                        <ItemTemplate>
                            <asp:Button ID="Button1" runat="server" CssClass="button_bak" Text="下线"  CommandName="OutOnline" OnClientClick="return confirm('确认要强制用户下线吗？');"  CommandArgument='<%# Eval("U_Guid")%>'></asp:Button>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
